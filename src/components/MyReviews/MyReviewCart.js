...
const MyReviewCart = ({ info, handleDelete }) => {
    const { serviceName, email, review, _id, postDate, ratings } = info;
    ...
    return (
        ...
        <div className='mt-5 border lg:w-96  bg-gray-800 p-3 rounded-lg'>
            ...
            <p className='my-2 text-sm text-gray-400'>Email: {email}</p>

            <div className='flex items-center mb-3'>
                <p className='mr-10'> <span className="text-xs text-gray-400">{postDate ? postDate : '2 days ago'}</span></p>

                <p className='text-yellow-500 flex justify-center items-center gap-1'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current">
